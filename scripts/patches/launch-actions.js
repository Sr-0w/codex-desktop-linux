...
function applyLinuxLaunchActionArgsPatch(currentSource) {
  ...
  if (
    ...
    patchedSource.includes("codexLinuxOpenDefaultWindow=async()=>") &&
    patchedSource.includes("codexLinuxIsDefaultOpenLaunch=e=>") &&
